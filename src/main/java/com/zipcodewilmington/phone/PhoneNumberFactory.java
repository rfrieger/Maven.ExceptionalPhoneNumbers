...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber createRandomPhoneNumber()  {
        ...
        Integer cent = RandomNumberFactory.createInteger(100, 999);
        Integer phone = RandomNumberFactory.createInteger(1000, 9999);
        return createPhoneNumberSafely(area, cent, phone);
    }
